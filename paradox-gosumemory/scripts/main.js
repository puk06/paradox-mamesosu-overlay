...
ws.onmessage = (wsEvent) => {
    try {
        /*receive*/
        Object.assign(tokenValue, ConvertTokenValue(JSON.parse(wsEvent.data)));
        ...
        /*bg*/
        if (cache.background.fullPath !== tokenValue.background.fullPath && backgroundReady === true) {
...
function ConvertTokenValue(wsdata) {
    const tokenValue = wsdata;
    return {
        audio: {
            fullPath: ""
        },
        ...
        modsArray: tokenValue.menu.mods.str.match(/.{2}/g),
        username: "Unknown",
        artistRoman: tokenValue.menu.bm.metadata.artist,
        artistUnicode: tokenValue.menu.bm.metadata.artistOriginal,
        titleRoman: tokenValue.menu.bm.metadata.title,
        titleUnicode: tokenValue.menu.bm.metadata.titleOriginal,
        c100: tokenValue.gameplay.hits[100],
        c50: tokenValue.gameplay.hits[50],
        miss: tokenValue.gameplay.hits[0],
        sliderBreaks: tokenValue.gameplay.hits.sliderBreaks,
        score: tokenValue.gameplay.score,
        acc: tokenValue.gameplay.accuracy,
        ...
        banchoId: 1,
        grade: tokenValue.gameplay.hits.grade.current,
        playerHpSmooth: tokenValue.gameplay.hp.smooth,
        ppIfMapEndsNow: tokenValue.gameplay.pp.current,
        keyOverlay: tokenValue.gameplay.keyOverlay,
        hitErrors: tokenValue.gameplay.hits.hitErrorArray,
        time: tokenValue.menu.bm.time.current,
        creator: tokenValue.menu.bm.metadata.mapper,
        diffName: tokenValue.menu.bm.metadata.difficulty,
        mode : tokenValue.menu.gameMode,
        starsNomod: tokenValue.menu.bm.stats.fullSR,
        totaltime: tokenValue.menu.bm.time.full,
        bpm: tokenValue.menu.bm.stats.BPM.max,
        cs: tokenValue.menu.bm.stats.CS,
        ar: tokenValue.menu.bm.stats.AR,
        od: tokenValue.menu.bm.stats.OD,
        hp: tokenValue.menu.bm.stats.HP,
        mBpm: tokenValue.menu.bm.stats.BPM.max,
        mCS: tokenValue.menu.bm.stats.CS,
        mAR: tokenValue.menu.bm.stats.AR,
        mOD: tokenValue.menu.bm.stats.OD,
        mHP: tokenValue.menu.bm.stats.HP,
        mods: tokenValue.menu.mods.str,
        mp3Name: tokenValue.menu.bm.path.audio,
        mStars: tokenValue.menu.bm.stats.fullSR,
        liveStarRating: tokenValue.menu.bm.stats.fullSR,
        rankedStatus: tokenValue.menu.bm.rankedStatus,
        rawStatus: tokenValue.menu.state,
        totalAudioTime: tokenValue.menu.bm.time.full,
        osuIsRunning: 1
    };
}
